...
function createThumbs($image) {
            ...
            if(file_exists($image)){
                    ...
                    if($source_size !== false){
                            ...
                            switch($source_size["mime"]){
                                    case "image/jpeg" : imagejpeg($thumb, $image); break;
                                    case "image/png" : imagepng($thumb, $image); break;
                                    case "image/gif" : imagegif($thumb, $image); break;
                            }
                    }
            }
    }
